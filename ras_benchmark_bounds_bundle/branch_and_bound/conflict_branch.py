...
from dp.network_dp_interface import Arc, BranchRestrictions
from dp.headway_model import HEADWAY_MODEL_LEGACY_ENTRY
...
def build_conflict(edge: Mapping[str, object], *, time_step: float,
    ...
    from .soft_lagrangian import _physical_leg_pair_conflict
